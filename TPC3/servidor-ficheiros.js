        ...
        <body>
            <div class="w3-card-4">
                ...
                <footer class="w3-container w3-blue">
                    <h5>Generated by EngWeb2024 :: A100665 [<a href="/actors"> Voltar à lista</a>]</h5>
                </footer>
            </div>
        </body>
    </html>
...
function genAtores(atores) {
    ...
    atores.forEach(ator => {
        pagHTML += `
            <tr>
                <td><a href="/actors/${ator.id}">${ator.id}</a></td>
                <td>${ator.name}</td>
    ...
    <html>
        ...
        <body>
            <div class="w3-card-4">
                ...
                <footer class="w3-container w3-blue">
                    <h5>Generated by EngWeb2024 :: A100665 [<a href="/genres"> Voltar à lista</a>]</h5>
                </footer>
            </div>
        </body>
    </html>
...
http.createServer(function (req, res) {
    ...
    var regex_actors = /^\/actors\/[a-z0-9]+$/
    var regex_genres = /^\/genres\/[a-z0-9]+$/
